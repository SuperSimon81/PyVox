...
public class Chunk  
{
	...
	public byte[,,] randColorMap = new byte[VoxelData.ChunkWidth, VoxelData.ChunkHeight, VoxelData.ChunkWidth];
		...
		for (int y = 0; y < VoxelData.ChunkHeight; y++) {
			for (int x = 0; x < VoxelData.ChunkWidth; x++) {
				for (int z = 0; z < VoxelData.ChunkWidth; z++) {
					...
					randColorMap[x,y,z]= (byte) Random.Range(0,255);
    ...
    Color c1 = world.blocktypes[voxelMap[x,y,z]].c1;
    Color c2 = world.blocktypes[voxelMap[x,y,z]].c2;
    Color randcolor = Color.Lerp(c1, c2, (float)randColorMap[x,y,z]/255 );
