...
public class World : MonoBehaviour {
    ...
    private void Start() {
        ...
        camera.transform.position = spawnPosition + camera.transform.position;
    ...
    public byte GetVoxel(Vector3 pos){
        ...
        int terrainHeight = Mathf.FloorToInt(VoxelData.ChunkHeight * Noise.Get2DPerlin(new Vector2(pos.x,pos.z),1,biome.terrainScale))/5;
        byte voxelValue = 0;
        ...
        if (voxelValue==2 || voxelValue==4 || voxelValue==3) 
        {
...
if(yPos>lode.minHeight && yPos < lode.maxHeight)
    if (Noise.Get3DPerlin(pos,lode.noiseOffset,lode.scale,lode.threshold))
     ...
     public bool CheckForVoxel3(float _x,float _y, float _z)
     { 
